...
(function () {
  ...
  var toolsCatalog = {
    zh: [
      ...
      { icon: '📏', name: '单位换算器', desc: '英制与公制单位互转：长度、重量、温度、体积。输入即实时换算，无需点击。', url: '/en/unit-converter/' },
      { icon: '📄', name: '简历生成器', desc: '在线制作专业简历与求职信。免费模板、实时预览、一键导出 PDF。', url: '/en/resume-builder/' },
      { icon: '💰', name: '销售税计算器', desc: '计算美国各州销售税。输入金额、选择州份，立即显示税前价、税额与总价。', url: '/en/sales-tax-calculator/' },
      { icon: '🗺️', name: '美国邮编查询', desc: '快速查询美国 ZIP 编码。显示城市、州、县、区号与时区信息。', url: '/en/zip-code-lookup/' },
      { icon: '📅', name: '美国节假日', desc: '查看任意年份的美国联邦节假日。距下个节日倒计时，当日高亮显示。', url: '/en/us-holidays/' },
      { icon: '🔮', name: '姓名诊断', desc: '输入姓名测试运势！大吉到末吉，轻松占卜，适合分享到社交平台。', url: '/ja/fortune-diagnosis/' },
      { icon: '📮', name: '日本邮编查询', desc: '查询日本〒邮政编码。显示都道府县、市区町村、町域名。', url: '/ja/zip-code-lookup/' },
      { icon: '🎂', name: '年龄计算器', desc: '由出生日期精确计算年龄。支持和历（令和/平成/昭和），显示星座与下次生日倒计时。', url: '/ja/age-calculator/' },
      { icon: '✍️', name: '文字数统计', desc: '实时统计字符数。分别统计汉字、平假名、片假名，一键复制结果。', url: '/ja/char-counter/' },
      { icon: '📋', name: '简历作成工具', desc: '在线制作日式履历书。输入学历、职历、资格后预览，支持打印。', url: '/ja/resume-builder/' },
      { icon: '🆔', name: 'CURP/RFC 生成器', desc: '生成并验证墨西哥 CURP 与 RFC。采用财政部官方算法。', url: '/es/curp-generator/' },
      { icon: '🆔', name: 'RUT 验证器', desc: '使用模 11 算法验证智利 RUT。可生成有效随机 RUT，自动格式化。', url: '/es/rut-validator/' },
      { icon: '🆔', name: 'DNI/NIE 验证器', desc: '验证西班牙 DNI 与 NIE。计算身份证与外籍人士证件控制字母。', url: '/es/dni-validator/' },
      { icon: '💱', name: '货币换算器', desc: '换算拉丁美洲货币：MXN、ARS、CLP、PEN、COP、USD。参考汇率实时更新。', url: '/es/currency-converter/' },
      { icon: '🕐', name: '时区转换器', desc: '拉丁美洲多时区时间转换。墨西哥城、布宜诺斯艾利斯、圣地亚哥、利马、波哥大实时时钟。', url: '/es/timezone-converter/' },
      { icon: '🆔', name: 'CPF/CNPJ 验证器', desc: '使用巴西联邦税务局官方算法验证并生成 CPF 与 CNPJ。自动格式化。', url: '/pt/cpf-cnpj-validator/' },
      { icon: '📮', name: '巴西邮编查询', desc: '查询巴西 CEP 编码。显示街道、街区、城市与州。', url: '/pt/cep-lookup/' },
      { icon: '💰', name: 'INSS 计算器', desc: '计算巴西 INSS 社保缴费。2025-2026 累进税率表，税率 7.5% 至 14%。', url: '/pt/inss-calculator/' },
      { icon: '📅', name: '巴西节假日', desc: '查看所有巴西国家法定节日。距下个节日倒计时。', url: '/pt/brazil-holidays/' },
      { icon: '💱', name: '货币转换器', desc: '将巴西雷亚尔兑换为 USD、EUR、GBP、ARS。参考汇率与货币对照卡。', url: '/pt/currency-converter/' },
    ],
    en: [
